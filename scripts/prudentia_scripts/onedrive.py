...
def _write_workflow_artifact(generated: dict) -> None:
    ...
    workflow_path = os.path.join(workflow_dir, "onedrive_workflow.json")
...
async def main() -> None:
    ...
    specification = """1. Go to 'https://1drv.ms/u/c/4c706cc78a96c093/IQCJuNpl5kb1QJnzUaLxrJCUAdXerzosGllMTrOsSt7NkDw?e=IVJRjK'.

...
def _write_workflow_artifact(generated: dict) -> None:
    ...
    workflow_path = os.path.join(workflow_dir, "youtube_workflow.json")
...
async def main() -> None:
    ...
    specification = """1. Go to 'https://www.youtube.com/watch?v=YE7VzlLtp-4&autoplay=1'.
    ...
    6. Watch the video for 10 seconds, then stop."""
    parameters = {}
